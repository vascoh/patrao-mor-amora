...
const FALLBACK: Testimonial[] = [
  ...
  { id: "3", text: "Fiz o Marinheiro Júnior na Patrão Mor Amora e foi a melhor decisão que poderia ter tomado. Os instrutores são fantásticos, o ambiente é muito acolhedor e aprendi muito mais do que esperava. Já estou inscrito no curso de Marinheiro!", course: "Marinheiro Júnior", author: "Miguel Costa", info: "Aluno 2025 · Setúbal", avatar: "MC", stars: 5, display_order: 2, is_active: true, created_at: "" },
  ...
  { id: "5", text: "O Marinheiro foi mais exigente do que esperava, mas os professores acompanham-te em cada etapa. Aprendi a ler cartas, a manobrar e a lidar com imprevistos reais. Uma formação que vale cada hora investida.", course: "Marinheiro", author: "Tiago Lopes", info: "Aluno 2025 · Amora", avatar: "TL", stars: 5, display_order: 4, is_active: true, created_at: "" }
];
