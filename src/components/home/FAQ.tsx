...
const FALLBACK: FaqItem[] = [
  ...
  { id: "3", question: "Os cursos têm aulas online disponíveis?", answer: "Sim! A componente teórica de alguns cursos pode ser feita online com os nossos materiais digitais e aulas em vídeo. A componente prática (manobras, simulações, etc.) é sempre presencial. O curso de Meteorologia Náutica é 100% online.", display_order: 2, is_active: true, created_at: "" },
  ...
  { id: "8", question: "A certificação PADI tem validade internacional?", answer: "Sim! O certificado PADI é reconhecido em mais de 180 países e mais de 6.600 centros de mergulho em todo o mundo. É o certificado de mergulho mais reconhecido internacionalmente. Uma vez obtido, é válido para toda a vida.", display_order: 7, is_active: true, created_at: "" }
];
