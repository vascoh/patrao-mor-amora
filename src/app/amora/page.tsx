...
export const metadata: Metadata = {
  ...
  description: "Escola náutica certificada pela DGRM em atividade contínua desde 1981. Cursos de Patrão Local, Patrão de Costa, Alto Mar, Vela e Mergulho PADI. Amora, margem sul do Tejo.",
  alternates: { canonical: "https://patraomor.pt/amora" }
};

export default async function AmoraPage() {
